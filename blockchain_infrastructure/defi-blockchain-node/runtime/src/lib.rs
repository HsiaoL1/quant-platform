...
pub const WEI_PER_GAS: u128 = 20_000_000_000u128; // 20 gwei
...
/// EVM Chain ID pallet configuration
...
parameter_types! {
	pub BlockGasLimitStorageKey: [u8; 32] = [0u8; 32];
...
impl pallet_evm::Config for Runtime {
	...
	type WeightPerGas = ConstU64<WEIGHT_PER_GAS>;
...
impl pallet_assets::Config for Runtime {
	...
	type CreateOrigin = frame_support::traits::AsEnsureOriginWithArg<
		frame_system::EnsureSignedBy<frame_support::traits::IsInVec<AccountId>, AccountId>,
	>;
	type ForceOrigin = frame_system::EnsureRoot<AccountId>;
	type AssetDeposit = ConstU128<1000>;
	type AssetAccountDeposit = ConstU128<100>;
	type MetadataDeposit = ConstU128<1000>;
	type ApprovalDeposit = ConstU128<100>;
...
parameter_types! {
	...
	pub const ProposalBondMaximum: Balance = 500;
...
impl pallet_treasury::Config for Runtime {
	...
	type Paymaster = frame_support::traits::PayFromAccount<Balances, TreasuryAccount>;
	type BalanceConverter = frame_support::traits::UnityAssetBalanceConversion;
...
/// Collective pallet configuration for council
parameter_types! {
...
impl pallet_collective::Config<CouncilCollective> for Runtime {
	...
	type MaxProposalWeight = frame_support::traits::MaxEncodedLen<RuntimeCall>;
}

/// Democracy pallet configuration
parameter_types! {
...
construct_runtime!(
	pub struct Runtime {
		// System support pallets
		System: frame_system,
		Timestamp: pallet_timestamp,
		Aura: pallet_aura,
		Grandpa: pallet_grandpa,
		
		// Balances and transaction payment
...
impl_runtime_apis! {
	...
	impl fp_rpc::EthereumRuntimeRPCApi<Block> for Runtime {
		...
		fn pending_block(
			xts: Vec<<Block as BlockT>::Extrinsic>,
		) -> (Option<pallet_ethereum::Block>, Option<Vec<pallet_ethereum::TransactionStatus>>) {
